...
| [`@typescript-eslint/strict-boolean-expressions-jsx`](./docs/rules/strict-boolean-expressions-jsx.md)                 | Restricts the types allowed in boolean expressions in JSX conditionals                                                  |                    |          | :thought_balloon: |
