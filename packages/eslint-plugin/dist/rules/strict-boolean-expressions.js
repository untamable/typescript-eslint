...
const isLogicalExpression = (arg) => arg.type === experimental_utils_1.AST_NODE_TYPES.LogicalExpression;
const isLogicalAndExpression = (arg) => isLogicalExpression(arg) && arg.operator === '&&';
const isUnaryExpression = (arg) => arg.type === experimental_utils_1.AST_NODE_TYPES.UnaryExpression;
const isBinaryExpression = (arg) => arg.type === experimental_utils_1.AST_NODE_TYPES.BinaryExpression;
const isCallExpression = (arg) => arg.type === experimental_utils_1.AST_NODE_TYPES.CallExpression;
const isIdentifier = (arg) => arg.type === experimental_utils_1.AST_NODE_TYPES.Identifier;
const isBooleanCast = (arg) => isCallExpression(arg) &&
    isIdentifier(arg.callee) &&
    arg.callee.name === experimental_utils_1.AST_TOKEN_TYPES.Boolean;
    ...
    create(context, [options]) {
        ...
        function checkJsxExpression(node) {
            if (isLogicalAndExpression(node.expression)) {
                if (isUnaryExpression(node.expression.left) ||
