...
exports.default = util_1.createRule({
    ...
    create(context, [{ formatWithPrettier }]) {
        ...
        function prettierFormat(code, location) {
            ...
            try {
                return prettier_1.format(code, Object.assign(Object.assign({}, prettierConfig), { parser: 'typescript' })).trimRight(); // prettier will insert a new line at the end of the code
            }
            catch (ex) {
